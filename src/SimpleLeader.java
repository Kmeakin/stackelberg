...
final class SimpleLeader extends PlayerImpl {
	...
	/**
	 * Generate a random price based Gaussian distribution. The mean is p_mean, and
	 * the diversity is p_diversity
	 * 
